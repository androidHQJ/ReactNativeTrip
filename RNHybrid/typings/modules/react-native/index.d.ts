...
// Source: https://raw.githubusercontent.com/DefinitelyTyped/DefinitelyTyped/6241f19520e3ab6e62dd3b6f8cc8e75b89469a80/react-native/index.d.ts
...
export interface TextInputIOSProperties {
    ...
    /**
     * See DocumentSelectionState.src, some state that is responsible for maintaining selection information for a document
     */
 ...
 * This system is implemented in ResponderEventPlugin.src, which contains further details and documentation.
 *
 * Best Practices
...
/**
 * //FIXME: No documentation extracted from code comment on WebView.ios.src
 */
 ...
 * `removeClippedSubviews = true` on a `ScrollView.src`).
 *
 * CAUTION: This is an experimental component and should only be used together
 * with javascript implementation of list view (see ListView.src). In order to
...
export interface SliderProperties extends SliderPropertiesIOS, React.Props<SliderStatic> {
    ...
    /**
     * Used to style and layout the Slider. See StyleSheet.src and ViewStylePropTypes.src for more info.
     */
    style?: ViewStyle
...
export interface MapViewProperties extends ViewProperties, React.Props<MapViewStatic> {
    ...
    /**
     * Insets for the map's legal label, originally at bottom left of the map. See EdgeInsetsPropType.src for more information.
     */
     ...
     * See StyleSheet.src and ViewStylePropTypes.src for more info.
     */
    style?: ViewStyle
...
/**
 * @see https://github.com/facebook/react-native/blob/0.34-stable\Libraries\Components\Touchable\Touchable.src
 */
...
export namespace NavigatorStatic {
    ...
    // @see NavigationBarStyle.ios.src
    ...
    export interface BreadcrumbNavigationBarStyle {
        //TODO &see NavigatorBreadcrumbNavigationBar.src
    }
...
// @see https://github.com/facebook/react-native/blob/0.34-stable\Libraries\StyleSheet\StyleSheetTypes.src
...
/**
 * //FIXME: Could not find docs. Inferred from examples and jscode : ListViewDataSource.src
 */
...
// Deduced from DatePickerAndroid.android.src
...
export interface FetchableListenable<T> {
     ...
     * //FIXME: No doc - inferred from NetInfo.src
     */
 ...
 *
 * //FIXME: BGR: The documentation seems completely off compared to the actual src implementation. I could never get the example to run
 */
 ...
 * @see https://github.com/facebook/react-native/blob/0.34-stable\Libraries\EventEmitter\RCTNativeAppEventEmitter.src
